...
namespace LocacaoDeGaragens.Controllers
{
    public class ModeloMotoesController : ApiController
    {
        ...
        public IQueryable<ModeloMoto> GetModeloMotos()
        {
            return db.ModeloMotos;
        }
        ...
        {
            ModeloMoto modeloMoto = await db.ModeloMotos.FindAsync(id);
            if (modeloMoto == null)
            {
                return NotFound();
            }
        ...
        public async Task<IHttpActionResult> DeleteModeloMoto(int id)
        {
            ...
            db.ModeloMotos.Remove(modeloMoto);
            await db.SaveChangesAsync();
        ...
        {
            return db.ModeloMotos.Count(e => e.Id == id) > 0;
        }
    }
}